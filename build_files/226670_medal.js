    ...
    app = {
        ...
        tplVars: {
            images: {
                ...
                paths: {
                    body: ['cdn', 'medals/summary/' + 226670 + '_medal_summary.gif'],
            ...
            registeredText: '',
            participatingText: '',
            target: 'http://www.bizrate.com/ratings_guide/merchant_detail__mid--' + 226670 + '.html?rf=sur',
            certified: true,
			MID: '226670',		
	    ...
	    setShowMouseOver: function () {
	    	...
	    	safeMerchantName = this.escapeString("Build.com");
